##################### REPRESENTACION DE NUMERO DECIMAL EN SISTEMA IEEE754 ###########################
#Parte entera
parteEntera=int(input("Ingresar la parte entera de un numero positivo o negativo para ser convertido a IEEE754: "))
signo=""
if parteEntera<0:
  signo="1"
else:
...
#Parte decimal
parteDecimal=float(input("Ingresar la parte decimal del numero anterior para ser convertido IEEE754 (Ej.: 0.x): "))
...
print("NORMALIZACION Y CÁLCULO DE EXPONENTE EN CD(2,8) CON FRONTERA CON EXCESO EN 1")
listaExponente=[]

#CALCULO rcd
exponente=len(entera)
exponenteImprimir=exponente-1
print("el exponente es: ",exponenteImprimir)
rcd=127+exponente-1
...
print("El número ",enteroimp+decimalimp,"en IEEE754 se representa: ",numeroHexa)
